 ...
 */
final class Version20220805190216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analyse_technique (id INT AUTO_INCREMENT NOT NULL, actif VARCHAR(255) NOT NULL, analyse VARCHAR(255) NOT NULL, explication LONGTEXT NOT NULL, date DATETIME NOT NULL, utilisateur VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
